...
class LPLLanding extends ComponentBase {
	...
	render() {
        ...
        <div class="wrapper">
            <section id="mercury">
                <h2>Mercury <span>on Desktop</span></h2>
                <p>A webcam app for light painting in real-time - for Mac &amp; Windows. </p>
                <div class="mercury-btns">
                    <div class="launch-btn btn">
                        <div class="icon"></div><a href="./download-mercury.html">Mercury v3 (free)</a>
                    </div>
                    <div class="pro-btn btn">
                        <div class="icon"></div><a href="./download-mercury-pro.html">Mercury Pro (buy)</a>
                    </div>
                </div><iframe class="video" src="//www.youtube.com/embed/qO7gYBkJjow" frameborder="0" allowfullscreen></iframe>
                <div class="sub-section faq">
                    <h2>Frequently asked questions</h2>
                    <h3>Can I use a DSLR with LPL?</h3>
                    <p>Yes, but it requires 3rd party software. Generally the video feed from DSLR to webcam is low
                        resolution and low framerate. Webcams work best because they are made for streaming.</p>
                    <p><a class="shiny" href="http://extrawebcam.com/" target="_blank">extrawebcam</a></p>
                    <h3>What webcam should I use?</h3>
                    ...
                    <h3>How can I control exposure on my webcam?</h3>
            ...
            <section id="story">
                ...
                <div class="person">
                    <h3>Joerg Miedza: Artist</h3><img src="assets/images/joerg.jpg">
                ...
                <div class="person">
                    <h3>Josh Beckwith: Developer</h3><img src="assets/images/josh.jpg">
                    <div class="content-block">
